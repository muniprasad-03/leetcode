// Last updated: 09/05/2026, 00:52:08
1class Solution {
...
33                if(curr == n-1) return steps;
34                int p = nums[curr];
35                if(curr+1 < n && !vis[curr+1]) {
36                    vis[curr+1] = true;
37                    queue.offer(curr+1);
38                }
39                if(curr-1 >= 0 && !vis[curr-1]) {
40                    vis[curr-1] = true;
41                    queue.offer(curr-1);
42                }
43                if(p > 1 && isPrime[p]) {
